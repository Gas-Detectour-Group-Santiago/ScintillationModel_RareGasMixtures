...
output_pdf = os.path.join(
    plots_dir,
    "LIP_ArCF4_HeCF4_VIS_UV_theory_exp_band_ArCF4.pdf"
)
...
def build_secondary_population(gas_name, case_name, ECF3=15.88):
    """
    ...
    read_garfield_csv_folder(
        ...
        dataframe=secondary_population_config(ECF3=ECF3),
...
# PARAMETERS
# ============================================================
def load_parameters(csv_name, Pscint, PCF4):
    par = pd.read_csv(
...
def compute_theory(par, subset, pressure):
    ...
    # Misma definición que en tus scripts:
    # UV observable = 0.8 * (UV + 0.25 * VIS)
    y_uv = y_uv_raw + 0.2 * y_vis
...
ax.set_title(r"LIP GEM 0.050 mm: Ar-CF$_4$ and He-CF$_4$ VIS")
