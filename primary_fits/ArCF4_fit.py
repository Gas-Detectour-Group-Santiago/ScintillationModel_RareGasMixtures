...
PARAMETERS = [
    ...
    Parameter("P_CF3_vis_dir", r"$P_{\mathrm{CF_3}}|_{\mathrm{vis,dir}}$", 6.97523694e-02, 0.0, 1.0),
    Parameter("P_Ar_dbleStar", r"$P_{\mathrm{Ar}^{**}}$", 1.50511150e-01, 0.0, 1.0),
    Parameter("K_Ar_dbleStar_Q_Ar", r"$K_{\mathrm{Ar}^{**},Q(\mathrm{Ar})}$ [ns]", 3.89959971e-01, 0.0, 10000.0),
    Parameter("K_Ar_dbleStar_Q_CF4", r"$K_{\mathrm{Ar}^{**},Q(\mathrm{CF}_4)}$ [ns]", 1.14938357e01, 0.0, 10000.0),
    ...
    Parameter("P_CF4_dir", r"$P_{\mathrm{CF_4}^{+,*}}|_{\mathrm{dir}}$", 2.36307283e-01, 0.0, 1.0),
    Parameter("K_Ar3rd_Q_CF4", r"$K_{\mathrm{Ar}^{++},Q(\mathrm{CF}_4)}$ [ns]", 5.005e01, 50.0, 50.2, fixed=True, fixed_value=50.05),
    Parameter("P_Ar3rd", r"$P_{\mathrm{Ar}^{++}}$", 5.18971635e-01, 0.0, 1.0),
    Parameter("P_CF3_uv_dir", r"$P_{\mathrm{CF_3}}|_{\mathrm{uv,dir}}$", 1.0e-04, 0.0, 1.0e-04),
]
...
PLOTS = [
    PlotSpec(
        ...
        title=r"Primary ArCF$_4$ Visible Yield fit",
    ...
    PlotSpec(
        ...
        title=r"Primary ArCF$_4$ UV Yield fit",
        xlabel=r"Concentration of CF$_4$ [$\%$]",
        ylabel="Arb. /eV",
        x_col="fCF4",
        min_positive_x=1e-5,
