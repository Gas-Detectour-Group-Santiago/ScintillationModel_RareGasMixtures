...
PARAMETERS = [
    ...
    Parameter("P_N2", r"$P_{\mathrm{N}_2}$", 0.0, 0.0, 1.0),
    Parameter("tau_N2", r"$\tau_{\mathrm{N}_2}$ [ns]", *_semi(tau_N2), fixed=True, fixed_value=tau_N2, fixed_error=0.376),
    Parameter("K_N2_Q_N2", r"$K_{\mathrm{N}_2Q(\mathrm{N}_2)}$ [ns$^{-1}$]", *_semi(K_N2_Q_N2)),
    Parameter("K_N2_Q_Ar", r"$K_{\mathrm{N}_2Q(\mathrm{Ar})}$ [ns$^{-1}$]", *_semi(K_N2_Q_Ar)),
    Parameter("K_ArMeta_Q_N2c", r"$K_{\mathrm{Ar}_{1s5}Q(\mathrm{N}_2(C))}$ [ns$^{-1}$]", *_semi(K_ArMeta_Q_N2c)),
    Parameter("K_ArMeta_Q_N2b", r"$K_{\mathrm{Ar}_{1s5}Q(\mathrm{N}_2(B))}$ [ns$^{-1}$]", *_semi(K_ArMeta_Q_N2b)),
    Parameter("K_ArMeta_Q_2Ar", r"$K_{\mathrm{Ar}_{1s5}Q(2\mathrm{Ar})}$ [ns$^{-1}$]", *_semi(K_ArMeta_Q_2Ar)),
    Parameter("K_ArRes_Q_N2c", r"$K_{\mathrm{Ar}_{1s4}Q(\mathrm{N}_2(C))}$ [ns$^{-1}$]", *_semi(K_ArRes_Q_N2c)),
    Parameter("K_ArRes_Q_N2b", r"$K_{\mathrm{Ar}_{1s4}Q(\mathrm{N}_2(B))}$ [ns$^{-1}$]", *_semi(K_ArRes_Q_N2b)),
    Parameter("K_ArRes_Q_2Ar", r"$K_{\mathrm{Ar}_{1s4}Q(2\mathrm{Ar})}$ [ns$^{-1}$]", *_semi(K_ArRes_Q_2Ar)),
    Parameter("P_Ar_dbleStar", r"$P_{\mathrm{Ar}^{**}}$", 0.0, 0.0, 1.0),
...
PLOTS = [
    ...
    PlotSpec(
        ...
        pressures=[1],
        concentration_grid=np.logspace(-4, 0, 1000),
        title=r"Primary ArN$_2$ fit 1 bar components",
        xlabel=r"Concentration of N$_2$ [$\%$]",
        ylabel="Normalized Yield",
        x_col="fN2",
        min_positive_x=1e-3,
    ...
    PlotSpec(
        ...
        pressures=[5],
        concentration_grid=np.logspace(-4, 0, 1000),
        title=r"Primary ArN$_2$ fit 5 bar components",
        xlabel=r"Concentration of N$_2$ [$\%$]",
        ylabel="Normalized Yield",
        x_col="fN2",
        min_positive_x=1e-3,
