...
Formato de salida:
    data/Spectra/ArCF4_raw_spectra.csv
    data/Spectra/ArN2_raw_spectra.csv
    data/Spectra/raw_spectra.csv
...
RUNS: tuple[SpectraRunConfig, ...] = (
    SpectraRunConfig(
        ...
        output_csv=SPECTRA_DIR / "ArCF4_raw_spectra.csv",
    ...
    SpectraRunConfig(
        ...
        output_csv=SPECTRA_DIR / "ArN2_raw_spectra.csv",
...
def main() -> None:
    ...
    combined_path = SPECTRA_DIR / "raw_spectra.csv"
