    ...
    return pd.DataFrame(
        {
            ...
            "Ar* 696": [["EXC"], "Ar", 13.32, 13.32 + 10.0, "Ar_696"],
            "Ar* 727": [["EXC"], "Ar", 13.32, 13.32 + 10.0, "Ar_727"],
...
def config_arn2_secondary() -> pd.DataFrame:
    return pd.DataFrame(
        {
            "Ar Meta": [["EXC"], "Ar", 0.0, 11.6, "Ar_meta"],
            "Ar Res": [["EXC"], "Ar", 11.6, 11.7, "Ar_res"],
            "Ar**": [["EXC"], "Ar", E_TH_AR_N2, 100.0, "Ar_dbleStar"],
            "N2*": [["C 3PI"], "N2", 11.0, 15.5, "N2_star"],
            "Ar* 696": [["EXC"], "Ar", 13.32, 13.32 + 10.0, "Ar_696"],
            "Ar* 727": [["EXC"], "Ar", 13.32, 13.32 + 10.0, "Ar_727"],
            "Ar* 750": [["EXC"], "Ar", 13.47, 13.47 + 10.0, "Ar_750"],
            "Ar* 763": [["EXC"], "Ar", 13.17, 13.17 + 10.0, "Ar_763"],
...
def main() -> None:
    for config in (*RUNS, *ARCF4_PAPER_RUNS):
        try:
