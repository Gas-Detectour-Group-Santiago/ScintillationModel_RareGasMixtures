...
if __name__ == "__main__":
    recompute_bands = os.environ.get("RECOMPUTE_BANDS", "0").lower() in {"1", "true", "yes", "on"}
    recompute_tables = os.environ.get("RECOMPUTE_TABLES", "0").lower() in {"1", "true", "yes", "on"}
    main(overwrite_bands=recompute_bands, overwrite_tables=recompute_tables)
