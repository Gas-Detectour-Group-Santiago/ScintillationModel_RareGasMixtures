...
# CSV-driven replacement for the production comparison figures. The legacy
# constants above are kept only as migration documentation; experimental points
# now live in data/raw/experimental/secondary_comparisons and are registered in
# config/experimental_datasets.csv.
from scintillation.plotting.recipe_config import load_secondary_multiband_plots as _load_secondary_multiband_plots_csv
from .auxiliares.prediction_types import CombinedBandCurveConfig
from .configs import _plot_normalization, _plot_ocw
