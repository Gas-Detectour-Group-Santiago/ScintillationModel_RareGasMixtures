...
parameter_data_og = pd.read_csv(os.path.join(DATA_DIR_PAR, "ArCF4_secondary_2_0.csv"))["parameter"].to_numpy()
...
probabilities = np.linspace((parameter_data_og[1]),0.2,22)
...
for i, gap in enumerate(gaps):
    ...
    for j,prob in enumerate(probabilities): 
            ...
            parameter_data[2] = 0.42 # prob # parameter_data_og[2] # max(parameter_data_og[1],parameter_data_og[2])/ # 0.35 # 
