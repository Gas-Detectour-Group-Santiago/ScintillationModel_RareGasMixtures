...
from spectra_generator.configs import comparison_spectra_configs  # noqa: E402
from spectra_generator.auxiliares.spectra_runner import SpectraRunner  # noqa: E402


def main(make_plots: bool = True) -> None:
    SpectraRunner(PROJECT_ROOT).run_comparison(comparison_spectra_configs(), make_plots=make_plots)
